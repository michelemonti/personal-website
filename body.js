...
const extraLanguageOverrides = {
  "es": {
    "biz_3festo_d": "Software MES para fabricación aditiva, hardware personalizado, utilidades de operaciones y servicios de TI avanzados para personas que realmente producen.",
    "biz_3festo_meta": "Responsable de Productos · desde 2020",
    ...
    "biz_juno_meta": "Director General · desde 2012",
    "biz_kicker": "Empresas",
    "biz_piva_cta": "como trabajo →",
    "biz_piva_d": "Colaboraciones directas con empresas y fundadores en AM, software de fabricación y equipos técnicos. Pocas cosas, bien hechas.",
    ...
    "cred_6": "Valle del Motor · Valle del Embalaje",
    ...
    "do_2_d": "Del prototipo a la serie: flujos de trabajo de producción, posprocesamiento, calidad, costes. El lado de AM sólo se ve dentro de un taller.",
    "do_2_t": "Industrialización y producción",
    "do_3_d": "Desarrollo full-stack, arquitecturas en la nube, MES para AM, IA aplicada a operaciones de cotización, producción y manufactura.",
    "do_3_t": "Software, IA y automatización",
    ...
    "hero_role": "Emprendedor de fabricación digital - CEO @ JUNO.AM · Jefe de productos @ 3FESTO / ANY3DP",
    ...
    "st_ch1_p1": "Mi primer encuentro con la impresión 3D industrial fue con una <strong>PolyJet, una Objet EDEN500V</strong>: resina de fotopolímero, capas de 16 micras, un nivel de detalle que en ese momento parecía ciencia ficción. No era un hobby: era creación de prototipos reales, para productos reales.",
    ...
    "st_ch2_p1": "En 2012 comenzó el viaje que se convertiría en <strong>JUNO.AM</strong>: una oficina de servicios profesionales de impresión 3D construida desde cero, en Emilia, entre Motor Valley y Packaging Valley, donde las empresas no compran promesas, compran piezas que funcionan.",
    "st_ch2_p2": "Construir un negocio de AM en Italia significa aprender todo a la vez: tecnología, ventas, operaciones, personas, flujo de caja. Es el campo de formación que convirtió a un técnico en emprendedor.",
    "st_ch3_h2": "FabLab y la cultura maker",
    "st_ch3_p1": "Durante los años del movimiento maker ayudé a llevar la fabricación digital fuera de las empresas, con el <strong>FabLab Valsamoggia</strong> y la comunidad local: cursos, máquinas abiertas, niños y artesanos que descubren lo que se puede hacer con un archivo y una impresora.",
    ...
    "st_ch4_p1": "Con <strong>HP Multi Jet Fusion</strong>, la impresión 3D dejó de ser un simple prototipo para convertirse en producción en serie. El nailon, la repetibilidad y los costos por pieza comienzan a competir con el moldeado para lotes pequeños y medianos.",
    "st_ch4_p2": "Todo cambia: ya no \"qué bonito es el prototipo\", sino calidad constante, posprocesamiento, logística, flujos. La AM se convierte en una cuestión de sistemas, no de máquinas.",
    "st_ch5_h2": "Carbon DLS: la asociación de Silicon Valley",
    "st_ch5_p1": "En 2020 gestioné personalmente la asociación con <strong>Carbon</strong>, una empresa de Silicon Valley, para llevar a producción la tecnología <strong>DLS</strong>: materiales de ingeniería, elastómeros, geometrías imposibles con otros procesos.",
    ...
    "st_ch7_h2": "IA, sistemas y personas",
    "st_ch7_p1": "Hoy el trabajo está haciendo que todo esto converja: <strong>IA aplicada a la fabricación</strong>, automatización de procesos, datos de producción convertidos en decisiones. Y equipos capaces de moverse entre el taller y el código sin perderse.",
    "st_ch7_p2": "Quince años después del primer PolyJet, la pregunta sigue siendo la misma: ¿cómo se convierte una idea en un objeto, de forma repetible y sostenible? Sólo ha cambiado la escala de la respuesta.",
    "st_ch7_y": "Hoy",
    "st_cta_btn": "Mira como trabajo",
    ...
    "tl_2009": "<strong>Primer contacto con la impresión 3D industrial.</strong> PolyJet, Objet EDEN500V: Nunca me fui.",
    "tl_2012": "<strong>Comienza el viaje de JUNO.AM.</strong> De la creación de prototipos a una oficina de servicios profesionales.",
    ...
    "tl_2020a": "<strong>Asociación Carbon DLS.</strong> Tecnología de Silicon Valley, puesta en producción y gestionada de primera mano.",
    "tl_2020b": "<strong>Nace 3FESTO / ANY3DP.</strong> MES y software para escalar la producción aditiva.",
    "tl_h2": "15 años en siete líneas",
    "tl_kicker": "Camino",
    "tl_more": "Leer la historia completa →",
    "tl_now": "<strong>IA y software para sistemas de fabricación.</strong> Automatización, datos y herramientas para las personas que fabrican cosas.",
    "tl_now_y": "Hoy",
    "vat_label": "IVA (IT) 03456789012",
    ...
    "wm_fit_no_3": "El objetivo es \"hacer algo con IA\" sin ningún problema que resolver.",
    ...
    "wm_svc1_t": "Revisión de la preparación para la producción AM",
    ...
    "wm_svc4_d": "Soporte en decisiones de inversión: MJF, DLS, DMLS, FDM, PolyJet, o ninguno de ellos. He trabajado con todos ellos; Sé lo que prometen y lo que cumplen.",
    "wm_svc4_t": "Decisiones sobre tecnología AM",
    "wm_svc5_d": "Qué tiene sentido construir, comprar o integrar: MES, cotizaciones, automatización, IA aplicada. De alguien que realmente creó software para AM.",
    "wm_svc5_t": "Hoja de ruta de software e inteligencia artificial para la fabricación",
    "wm_svc6_d": "Liderazgo temporal de producto, AM o un área técnica: para llenar un vacío, iniciar una función o liderar una transición.",
    "wm_svc6_t": "Liderazgo temporal/fraccional",
    "wm_svc7_d": "Sesiones prácticas sobre AM, DfAM, automatización e IA en la fabricación. Concreto, en su contexto, sin diapositivas motivacionales.",
    "wm_svc7_t": "Talleres para equipos técnicos y directivos.",
    "wm_svc8_d": "Para pymes y grupos industriales que quieran entender qué tiene realmente sentido hacer (y qué no) con la impresión 3D y la IA en su empresa.",
    "wm_svc8_t": "Orientación sobre AM e IA",
    "wm_title": "Trabajo selectivamente con personas que fabrican, diseñan o construyen software para manufactura.",
    "wm_vat_note": "Trabajo realizado bajo IVA (IT) 03456789012 — facturación regular, NDA cuando sea necesario."
  },
  "ca": {
    "biz_3festo_d": "Programari MES per a la fabricació additiva, maquinari personalitzat, utilitats d'operacions i serveis informàtics avançats per a persones que realment produeixen.",
    "biz_3festo_meta": "Cap de Productes · des del 2020",
    ...
    "biz_juno_meta": "CEO · des de 2012",
    "biz_kicker": "Ventures",
    "biz_piva_cta": "com treballo →",
    "biz_piva_d": "Col·laboracions directes amb empreses i fundadors en AM, programari de fabricació i equips tècnics. Poques coses, ben fetes.",
    ...
    "do_2_d": "Del prototip a la sèrie: fluxos de treball de producció, postprocessament, qualitat, costos. El costat de l'AM només es veu dins d'un taller.",
    "do_2_t": "Industrialització i producció",
    "do_3_d": "Desenvolupament full-stack, arquitectures al núvol, MES per a AM, IA aplicada a operacions de cotització, producció i fabricació.",
    "do_3_t": "Programari, IA i automatització",
    ...
    "hero_role": "Emprenedor de fabricació digital — CEO @ JUNO.AM · Cap de Productes @ 3FESTO / ANY3DP",
    ...
    "st_ch2_p2": "Construir un negoci d'AM a Itàlia significa aprendre-ho tot alhora: tecnologia, vendes, operacions, persones, flux de caixa. És el camp de formació que va convertir un tècnic en un emprenedor.",
    ...
    "st_ch4_p2": "Tot canvia: ja no “que bonic és el prototip”, sinó qualitat constant, postprocessament, logística, fluxos. AM es converteix en una qüestió de sistemes, no de màquines.",
    "st_ch5_h2": "Carbon DLS: l'associació de Silicon Valley",
    "st_ch5_p1": "L'any 2020 vaig gestionar personalment l'associació amb <strong>Carbon</strong>, una empresa de Silicon Valley, per introduir la tecnologia <strong>DLS</strong> en producció: materials d'enginyeria, elastòmers, geometries impossibles amb altres processos.",
    ...
    "st_ch7_h2": "IA, sistemes i persones",
    "st_ch7_p1": "Avui el treball fa convergir tot això: <strong>IA aplicada a la fabricació</strong>, automatització de processos, dades de producció convertides en decisions. I equips capaços de moure's entre taller i codi sense perdre's.",
    "st_ch7_p2": "Quinze anys després d'aquell primer PolyJet, la pregunta segueix sent la mateixa: com es converteix una idea en un objecte, de manera repetida i sostenible? Només ha canviat l'escala de la resposta.",
    "st_ch7_y": "Avui",
    ...
    "tl_2009": "<strong>Primer contacte amb la impressió 3D industrial.</strong> PolyJet, Objet EDEN500V: mai vaig marxar.",
    ...
    "tl_2020a": "<strong>Associació de Carbon DLS.</strong> Tecnologia de Silicon Valley, posada en producció i gestionada de primera mà.",
    "tl_2020b": "<strong>Neix 3FESTO / ANY3DP.</strong> MES i programari per escalar la producció additiva.",
    "tl_h2": "15 anys en set línies",
    "tl_kicker": "Camí",
    "tl_more": "Llegeix la història sencera →",
    "tl_now": "<strong>IA i programari per a sistemes de fabricació.</strong> Automatització, dades i eines per a les persones que fan coses.",
    "tl_now_y": "Avui",
    "vat_label": "IVA (IT) 03456789012",
    ...
    "wm_fit_no_3": "L'objectiu és \"fer alguna cosa amb IA\" sense problemes per resoldre.",
    ...
    "wm_m1_t": "Context",
    "wm_m2_d": "Anàlisi de camp: dades, màquines, fluxos, persones. El resultat és una imatge honesta i les prioritats reals, fins i tot quan la resposta és \"no necessiteu AM\".",
    "wm_m2_t": "Avaluació",
    ...
    "wm_svc1_t": "Revisió de la preparació per a la producció d'AM",
    "wm_svc2_d": "Revisió de peces i conjunts per a la producció additiva: geometries, materials, toleràncies, postprocessament. Redissenyeu per AM, no us limiteu a adaptar-vos.",
    ...
    "wm_svc4_t": "Decisions de tecnologia AM",
    "wm_svc5_d": "Què té sentit construir, comprar o integrar: MES, cotització, automatització, IA aplicada. D'algú que realment va crear programari per a AM.",
    "wm_svc5_t": "Full de ruta de programari i IA per a la fabricació",
    ...
    "wm_svc7_d": "Sessions pràctiques sobre AM, DfAM, automatització i IA a la fabricació. Concreta, al teu context, sense diapositives motivacionals.",
    "wm_svc7_t": "Tallers per a equips tècnics i directius",
    "wm_svc8_d": "Per a pimes i grups industrials que volen entendre què té sentit fer, i què no, amb la impressió 3D i la IA a la seva empresa.",
    "wm_svc8_t": "Orientació sobre AM i IA",
    "wm_title": "Treballo selectivament amb persones que fabriquen, dissenyen o construeixen programari per a la fabricació.",
    "wm_vat_note": "Treball realitzat amb IVA (IT) 03456789012 — facturació regular, NDA quan sigui necessari."
  },
  "fr": {
    "biz_3festo_d": "Logiciel MES pour la fabrication additive, matériel personnalisé, utilitaires d'exploitation et services informatiques avancés pour les personnes qui produisent réellement.",
    "biz_3festo_meta": "Chef de Produits · depuis 2020",
    ...
    "biz_juno_meta": "PDG · depuis 2012",
    "biz_kicker": "Entreprises",
    "biz_piva_cta": "comment je travaille →",
    "biz_piva_d": "Collaborations directes avec des entreprises et des fondateurs sur la fabrication additive, les logiciels de fabrication et les équipes techniques. Peu de choses, bien faites.",
    ...
    "cred_6": "Motor Valley · Vallée de l'emballage",
    "do_1_d": "HP MJF, Carbone DLS, DMLS, FDM, PolyJet. Conception pour la FA, rétro-ingénierie, sélection de technologies et de matériaux pour des applications réelles.",
    "do_1_t": "Fabrication additive et DfAM",
    "do_2_d": "Du prototype à la série: workflows de production, post-traitement, qualité, coûts. Le côté de l’AM que vous ne voyez qu’à l’intérieur d’un atelier.",
    "do_2_t": "Industrialisation & production",
    "do_3_d": "Développement full-stack, architectures cloud, MES pour AM, IA appliquée aux opérations de devis, de production et de fabrication.",
    "do_3_t": "Logiciels, IA et automatisation",
    ...
    "hero_cta_work": "Travaille avec moi",
    ...
    "hero_role": "Entrepreneur en fabrication numérique — PDG @ JUNO.AM · Responsable produits @ 3FESTO / ANY3DP",
    ...
    "st_ch2_h2": "Du prototype à l’entreprise: JUNO.AM",
    ...
    "st_ch2_p2": "Créer une entreprise de fabrication additive en Italie signifie tout apprendre en même temps: la technologie, les ventes, les opérations, les ressources humaines, les flux de trésorerie. C'est le terrain de formation qui a transformé un technicien en entrepreneur.",
    "st_ch3_h2": "FabLab et culture maker",
    "st_ch3_p1": "Pendant les années du mouvement des créateurs, j'ai contribué à amener la fabrication numérique à l'extérieur des entreprises, avec le <strong>FabLab Valsamoggia</strong> et la communauté locale: des cours, des machines ouvertes, des enfants et des artisans découvrant ce qu'on peut faire avec un fichier et une imprimante.",
    ...
    "st_ch4_h2": "Le saut vers la production: HP Multi Jet Fusion",
    "st_ch4_p1": "Avec <strong>HP Multi Jet Fusion</strong>, l'impression 3D a cessé d'être un simple prototypage: elle est devenue une production en série. Le nylon, la répétabilité et les coûts par pièce commencent à rivaliser avec le moulage de petites et moyennes séries.",
    "st_ch4_p2": "Tout change: non plus « comme le prototype est beau », mais une qualité constante, le post-traitement, la logistique, les flux. La fabrication additive devient une question de systèmes et non de machines.",
    "st_ch5_h2": "Carbon DLS: le partenariat de la Silicon Valley",
    "st_ch5_p1": "En 2020, j'ai personnellement géré le partenariat avec <strong>Carbon</strong>, une entreprise de la Silicon Valley, pour mettre en production la technologie <strong>DLS</strong>: matériaux d'ingénierie, élastomères, géométries impossibles avec d'autres procédés.",
    ...
    "st_ch6_h2": "Le logiciel à l'échelle: 3FESTO",
    "st_ch6_p1": "Cette même année, en parallèle, les travaux sur <strong>3FESTO / ANY3DP</strong> commencent: plus la production augmente, plus le véritable goulot d'étranglement se déplace des machines vers les logiciels qui les font fonctionner.",
    "st_ch6_p2": "MES pour la fabrication additive, les devis, l'automatisation des flux de travail, le matériel personnalisé. Des logiciels écrits par des personnes qui vivent réellement en production, et non imaginés dans une salle de réunion.",
    "st_ch7_h2": "IA, systèmes et personnes",
    "st_ch7_p1": "Aujourd’hui, le travail fait converger tout cela: <strong>IA appliquée à la fabrication</strong>, automatisation des processus, données de production transformées en décisions. Et des équipes capables de passer de l'atelier au code sans se perdre.",
    "st_ch7_p2": "Quinze ans après ce premier PolyJet, la question est toujours la même: comment transformer une idée en objet, de manière reproductible et durable? Seule l’ampleur de la réponse a changé.",
    ...
    "tl_2009": "<strong>Premier contact avec l'impression 3D industrielle.</strong> PolyJet, Objet EDEN500V: Je ne l'ai jamais quitté.",
    "tl_2012": "<strong>Le voyage JUNO.AM commence.</strong> Du prototypage à un bureau de services professionnels.",
    ...
    "tl_2020a": "<strong>Partenariat Carbon DLS.</strong> Technologie de la Silicon Valley, mise en production et gérée de première main.",
    "tl_2020b": "<strong>3FESTO / ANY3DP est né.</strong> MES et logiciels pour faire évoluer la production additive.",
    "tl_h2": "15 ans en sept lignes",
    "tl_kicker": "Chemin",
    "tl_more": "Lire l'histoire complète →",
    "tl_now": "<strong>IA et logiciels pour les systèmes de fabrication.</strong> Automatisation, données et outils pour les personnes qui fabriquent des objets.",
    ...
    "wm_fit_no_3": "Le but est de « faire quelque chose avec l’IA » sans problème à résoudre.",
    ...
    "wm_m1_t": "Contexte",
    "wm_m2_d": "Analyse sur le terrain: données, machines, flux, personnes. Le résultat est une image honnête et les véritables priorités, même lorsque la réponse est « vous n'avez pas besoin d'AM ».",
    "wm_m2_t": "Évaluation",
    ...
    "wm_svc1_t": "Examen de l'état de préparation à la production AM",
    "wm_svc2_d": "Revue de pièces et assemblages pour la production additive: géométries, matériaux, tolérances, post-traitement. Refonte pour la fabrication additive, ne vous contentez pas de vous adapter.",
    "wm_svc2_t": "DfAM et revue de conception",
    ...
    "wm_svc4_d": "Accompagnement sur les décisions d'investissement: MJF, DLS, DMLS, FDM, PolyJet — ou aucun d'entre eux. J'ai travaillé avec chacun d'eux; Je sais ce qu’ils promettent et ce qu’ils livrent.",
    "wm_svc4_t": "Décisions technologiques de fabrication additive",
    "wm_svc5_d": "Ce qui a du sens à construire, acheter ou intégrer: MES, devis, automatisation, IA appliquée. De quelqu'un qui a réellement créé des logiciels pour la fabrication additive.",
    "wm_svc5_t": "Feuille de route des logiciels et de l'IA pour la fabrication",
    "wm_svc6_d": "Leadership temporaire d'un produit, d'une AM ou d'un domaine technique: pour combler un manque, démarrer une fonction ou piloter une transition.",
    "wm_svc6_t": "Leadership temporaire/fractionné",
    "wm_svc7_d": "Sessions pratiques sur la FA, le DfAM, l'automatisation et l'IA dans le secteur manufacturier. Du concret, sur votre contexte, pas de slides motivationnels.",
    "wm_svc7_t": "Ateliers pour les équipes techniques et le management",
    "wm_svc8_d": "Pour les PME et les groupes industriels qui souhaitent comprendre ce qui a du sens – et ce qui ne l’est pas – avec l’impression 3D et l’IA dans leur entreprise.",
    "wm_svc8_t": "Conseils sur la FA et l'IA",
    ...
    "wm_vat_note": "Travaux réalisés sous TVA (IT) 03456789012 — facturation régulière, NDA si nécessaire."
  },
  "sr": {
    "biz_3festo_d": "МЕС софтвер за адитивну производњу, прилагођени хардвер, оперативне услужне програме и напредне ИТ услуге за људе који стварно производе.",
    "biz_3festo_meta": "Шеф производа · од 2020",
    ...
    "biz_juno_meta": "Генерални директор · од 2012",
    "biz_kicker": "Вентурес",
    "biz_piva_cta": "како радим →",
    "biz_piva_d": "Директна сарадња са компанијама и оснивачима на АМ, производном софтверу и техничким тимовима. Мало ствари, добро урађено.",
    ...
    "cred_4": "АМ + софтвер + људски тимови",
    "cred_5": "Болоња · Емилија-Ромања",
    "cred_6": "Долина мотора · Долина паковања",
    "do_1_d": "ХП МЈФ, Царбон ДЛС, ДМЛС, ФДМ, ПолиЈет. Дизајн за АМ, обрнути инжењеринг, избор технологије и материјала за стварне примене.",
    "do_1_t": "Адитивна производња и ДфАМ",
    "do_2_d": "Од прототипа до серије: токови производње, накнадна обрада, квалитет, трошкови. Страна АМ коју видите само у радионици.",
    "do_2_t": "Индустријализација и производња",
    "do_3_d": "Фулл стацк развој, цлоуд архитектуре, МЕС за АМ, АИ примењен на котирање, производњу и производне операције.",
    "do_3_t": "Софтвер, АИ и аутоматизација",
    ...
    "hero_role": "Дигитал Мануфацтуринг Ентрепренеур — ЦЕО @ ЈУНО.АМ · Шеф производа @ 3ФЕСТО / АНИ3ДП",
    "hero_sub": "Градим производе, системе и тимове у дигиталној производњи, за мала и средња предузећа и велике индустријске групе. Од Болоње — у срцу Емилије-Ромање, између долине мотора и долине паковања — водим адитивну производњу од израде прототипа до праве производње, са софтвером као полугом.",
    ...
    "st_ch1_p1": "Мој први сусрет са индустријским 3Д штампањем био је <strong>ПолиЈет, Објет ЕДЕН500В</strong>: фотополимерна смола, слојеви од 16 микрона, ниво детаља који је у то време изгледао као научна фантастика. То није био хоби: било је право прототиповање, за праве производе.",
    ...
    "st_ch2_h2": "Од прототипа до компаније: ЈУНО.АМ",
    "st_ch2_p1": "Године 2012. почело је путовање које ће постати <strong>ЈУНО.АМ</strong>: професионални биро за 3Д штампање изграђен од нуле, у Емилији, између Мотор Валлеи-а и Пацкагинг Валлеи-а — где компаније не купују обећања, оне купују делове који раде.",
    "st_ch2_p2": "Изградња АМ пословања у Италији значи научити све одједном: технологију, продају, операције, људе, ток новца. То је полигон који је техничара претворио у предузетника.",
    "st_ch3_h2": "ФабЛаб и култура произвођача",
    "st_ch3_p1": "Током година покрета за креаторе, помогао сам да се дигитална производња доведе ван компанија, са <strong>ФабЛаб Валсамоггиа</strong> и локалном заједницом: курсеви, отворене машине, деца и занатлије откривају шта можете да урадите са фајлом и штампачем.",
    ...
    "st_ch4_h2": "Скок у производњу: ХП Мулти Јет Фусион",
    "st_ch4_p1": "Са <strong>ХП Мулти Јет Фусион</strong>, 3Д штампање је престало да буде само прототип: постало је серијска производња. Најлон, поновљивост, трошкови по делу почињу да се такмиче са обликовањем за мале и средње серије.",
    "st_ch4_p2": "Све се мења: више не „како је леп прототип“, већ доследан квалитет, накнадна обрада, логистика, токови. АМ постаје ствар система, а не машина.",
    "st_ch5_h2": "Царбон ДЛС: партнерство из Силицијумске долине",
    "st_ch5_p1": "У 2020. години сам лично управљао партнерством са <strong>Царбон</strong>, компанијом из Силицијумске долине, да уведем <strong>ДЛС</strong> технологију у производњу: инжењерски материјали, еластомери, геометрије немогуће са другим процесима.",
    ...
    "st_ch6_h2": "Софтвер за скалирање: 3ФЕСТО",
    "st_ch6_p1": "Исте године, паралелно, почео је рад на <strong>3ФЕСТО / АНИ3ДП</strong>: што производња расте, више се право уско грло помера са машина на софтвер који их покреће.",
    "st_ch6_p2": "МЕС за адитивну производњу, цитирање, аутоматизацију тока посла, прилагођени хардвер. Софтвер који су написали људи који заправо живе у производњи, а не замишљени у сали за састанке.",
    "st_ch7_h2": "АИ, системи и људи",
    "st_ch7_p1": "Данас се све ово приближава: <strong>АИ примењен на производњу</strong>, аутоматизација процеса, подаци о производњи претворени у одлуке. А тимови могу да се крећу између радионице и кода, а да се не изгубе.",
    "st_ch7_p2": "Петнаест година након тог првог ПолиЈет-а, питање је и даље исто: како претворити идеју у објекат, поновљиво и одрживо? Само се размера одговора променила.",
    "st_ch7_y": "данас",
    ...
    "tl_2009": "<strong>Први контакт са индустријским 3Д штампањем.</strong> ПолиЈет, Објет ЕДЕН500В: Никад нисам отишао.",
    "tl_2012": "<strong>Јуно.АМ путовање почиње.</strong> Од израде прототипа до професионалног сервисног бироа.",
    "tl_2014": "<strong>ФабЛаб Валсамоггиа и култура произвођача.</strong> Досег, заједница, приступ дигиталној производњи.",
    "tl_2017": "<strong>ХП Мулти Јет Фусион.</strong> Скок од израде прототипа до серијске производње.",
    "tl_2020a": "<strong>Царбон ДЛС партнерство.</strong> Технологија Силицијумске долине, уведена у производњу и којом се управља из прве руке.",
    "tl_2020b": "<strong>3ФЕСТО / АНИ3ДП је рођен.</strong> МЕС и софтвер за повећање адитивне производње.",
    "tl_h2": "15 година у седам редова",
    "tl_kicker": "Пут",
    "tl_more": "Прочитајте целу причу →",
    "tl_now": "<strong>АИ и софтвер за производне системе.</strong> Аутоматизација, подаци и алати за људе који праве ствари.",
    "tl_now_y": "данас",
    "vat_label": "PDV (IT) 03456789012",
    ...
    "wm_fit_no_3": "Циљ је „урадити нешто са АИ“ без проблема за решавање.",
    ...
    "wm_m1_t": "Контекст",
    "wm_m2_d": "Анализа на терену: подаци, машине, токови, људи. Резултат је искрена слика и прави приоритети — чак и када је одговор „не треба вам АМ“.",
    "wm_m2_t": "Процена",
    ...
    "wm_svc1_t": "Преглед приправности АМ производње",
    "wm_svc2_d": "Преглед делова и склопова за адитивну производњу: геометрије, материјали, толеранције, накнадна обрада. Редизајнирајте за АМ, немојте се само прилагођавати.",
    "wm_svc2_t": "ДфАМ и преглед дизајна",
    ...
    "wm_svc4_d": "Подршка за инвестиционе одлуке: МЈФ, ДЛС, ДМЛС, ФДМ, ПолиЈет — или ниједна од њих. Радио сам са свима њима; Знам шта обећавају и шта испоручују.",
    "wm_svc4_t": "АМ технолошке одлуке",
    "wm_svc5_d": "Шта има смисла изградити, купити или интегрисати: МЕС, цитирање, аутоматизација, примењена АИ. Од некога ко је заправо направио софтвер за АМ.",
    "wm_svc5_t": "Софтвер и АИ мапа пута за производњу",
    "wm_svc6_d": "Привремено вођство над производом, АМ или техничком области: да попуни празнину, започне функцију или управља транзицијом.",
    "wm_svc6_t": "Привремено / фракционо вођство",
    "wm_svc7_d": "Практичне сесије о АМ, ДфАМ-у, аутоматизацији и АИ у производњи. Конкретно, у вашем контексту, без мотивационих слајдова.",
    "wm_svc7_t": "Радионице за техничке тимове и менаџмент",
    "wm_svc8_d": "За мала и средња предузећа и индустријске групе које желе да схвате шта заправо има смисла да раде – а шта не – са 3Д штампањем и вештачком интелигенцијом у њиховој компанији.",
    "wm_svc8_t": "Смернице за АМ & АИ",
    "wm_title": "Радим селективно са људима који производе, дизајнирају или граде софтвер за производњу.",
    "wm_vat_note": "Радови се обављају под ПДВ (ИТ) 03456789012 — редовно фактурисање, НДА по потреби."
  },
  "ru": {
    "biz_3festo_d": "Программное обеспечение MES для аддитивного производства, специальное оборудование, операционные утилиты и расширенные ИТ-услуги для людей, которые действительно производят.",
    "biz_3festo_meta": "Руководитель отдела продуктов · с 2020 г.",
    ...
    "biz_juno_meta": "Генеральный директор · с 2012 года",
    "biz_kicker": "Венчуры",
    "biz_piva_cta": "как я работаю →",
    "biz_piva_d": "Прямое сотрудничество с компаниями и основателями AM, производством программного обеспечения и техническими командами. Немного вещей, сделано хорошо.",
    ...
    "cred_4": "AM + Программное обеспечение + Человеческие команды",
    "cred_5": "Болонья · Эмилия-Романья",
    "cred_6": "Долина моторов · Долина упаковки",
    "do_1_d": "HP MJF, Carbon DLS, DMLS, FDM, PolyJet. Проектирование для AM, реверс-инжиниринг, выбор технологий и материалов для реального применения.",
    "do_1_t": "Аддитивное производство и DfAM",
    "do_2_d": "От прототипа к серии: технологические процессы производства, постобработка, качество, затраты. Сторону AM, которую можно увидеть только внутри мастерской.",
    "do_2_t": "Индустриализация и производство",
    "do_3_d": "Комплексная разработка, облачные архитектуры, MES для AM, искусственный интеллект, применяемый для ценообразования, производства и производственных операций.",
    "do_3_t": "Программное обеспечение, искусственный интеллект и автоматизация",
    ...
    "hero_role": "Предприниматель цифрового производства — Генеральный директор @ JUNO.AM · Руководитель отдела продуктов @ 3FESTO / ANY3DP",
    "hero_sub": "Я создаю продукты, системы и команды в сфере цифрового производства для малого и среднего бизнеса и крупных промышленных групп. В Болонье — в самом сердце Эмилии-Романьи, между Motor Valley и Packaging Valley — я веду аддитивное производство от прототипирования к реальному производству, используя программное обеспечение в качестве рычага.",
    "hint_interact": "Перетащите, чтобы повернуть 3D-тело.",
    "nav_home": "Дом",
    "nav_story": "История",
    "nav_work": "Работай со мной",
    "phil_kicker": "Зрение",
    ...
    "st_ch1_p1": "Моим первым знакомством с промышленной 3D-печатью стал <strong>PolyJet, Objet EDEN500V</strong>: фотополимерная смола, слои толщиной 16 микрон, уровень детализации, который в то время казался научной фантастикой. Это не было хобби: это было настоящее прототипирование реальных продуктов.",
    ...
    "st_ch2_h2": "От прототипов к компании: JUNO.AM",
    ...
    "st_ch2_p2": "Построить AM-бизнес в Италии — значит изучить все сразу: технологии, продажи, операции, людей, денежный поток. Это учебная площадка, которая превратила технического специалиста в предпринимателя.",
    "st_ch3_h2": "FabLab и культура производителей",
    "st_ch3_p1": "В годы движения производителей я помогал вывести цифровое производство за пределы компаний, вместе с <strong>FabLab Valsamoggia</strong> и местным сообществом: курсы, открытые машины, дети и ремесленники, открывающие, что можно сделать с файлом и принтером.",
    ...
    "st_ch4_p2": "Меняется все: уже не «насколько хорош прототип», а стабильное качество, постобработка, логистика, потоки. АМ становится вопросом систем, а не машин.",
    "st_ch5_h2": "Carbon DLS: партнерство Кремниевой долины",
    "st_ch5_p1": "В 2020 году я лично управлял партнерством с <strong>Carbon</strong>, компанией из Кремниевой долины, чтобы внедрить в производство технологию <strong>DLS</strong>: конструкционные материалы, эластомеры, геометрии, невозможные с помощью других процессов.",
    ...
    "st_ch6_p2": "MES для аддитивного производства, ценообразования, автоматизации рабочих процессов, нестандартного оборудования. Программное обеспечение, написанное людьми, которые на самом деле живут в производстве, а не в конференц-зале.",
    "st_ch7_h2": "ИИ, системы и люди",
    "st_ch7_p1": "Сегодня работа объединяет все это: <strong>ИИ в производстве</strong>, автоматизация процессов, производственные данные превращаются в решения. И команды могут перемещаться между мастерской и кодом, не теряясь.",
    "st_ch7_p2": "Спустя пятнадцать лет после появления первого PolyJet вопрос остается прежним: как превратить идею в объект, повторяемо и устойчиво? Изменился только масштаб ответа.",
    "st_ch7_y": "Сегодня",
    "st_cta_btn": "Посмотрите, как я работаю",
    "st_cta_h2": "Может ли этот опыт быть вам полезен?",
    "st_cta_mail": "Напиши мне",
    ...
    "tl_2009": "<strong>Первый контакт с промышленной 3D-печатью.</strong> PolyJet, Objet EDEN500V: Я никогда не уходил.",
    ...
    "tl_2020a": "<strong>Партнерство Carbon DLS.</strong> Технологии Кремниевой долины, внедренные в производство и управляемые из первых рук.",
    "tl_2020b": "<strong>Рождение 3FESTO / ANY3DP.</strong> MES и программное обеспечение для масштабирования аддитивного производства.",
    "tl_h2": "15 лет в семи строках",
    "tl_kicker": "Путь",
    "tl_more": "Читать всю историю →",
    "tl_now": "<strong>ИИ и программное обеспечение для производственных систем.</strong> Автоматизация, данные и инструменты для людей, которые что-то создают.",
    "tl_now_y": "Сегодня",
    "vat_label": "НДС (IT) 03456789012",
    "wm_cta_btn": "Напиши мне",
    ...
    "wm_fit_no_3": "Цель — «сделать что-нибудь с помощью ИИ», не требуя решения проблем.",
    ...
    "wm_m1_t": "Контекст",
    "wm_m2_d": "Анализ в полевых условиях: данные, машины, потоки, люди. Результатом является честная картина и реальные приоритеты — даже если ответ «вам не нужен АМ».",
    "wm_m2_t": "Оценка",
    ...
    "wm_svc1_t": "Проверка готовности производства АМ",
    ...
    "wm_svc2_t": "DfAM и обзор дизайна",
    ...
    "wm_svc4_t": "Технологические решения AM",
    "wm_svc5_d": "Что имеет смысл создавать, покупать или интегрировать: MES, квотирование, автоматизация, прикладной искусственный интеллект. От человека, который действительно создавал программное обеспечение для AM.",
    "wm_svc5_t": "Дорожная карта программного обеспечения и искусственного интеллекта для производства",
    ...
    "wm_svc7_d": "Практические занятия по AM, DfAM, автоматизации и искусственному интеллекту в производстве. Конкретно, по вашему контексту, никаких мотивационных слайдов.",
    "wm_svc7_t": "Семинары для технических команд и менеджмента",
    "wm_svc8_d": "Для малых и средних предприятий и промышленных групп, которые хотят понять, что на самом деле имеет смысл делать, а что нет — с 3D-печатью и искусственным интеллектом в их компании.",
    "wm_svc8_t": "Руководство по AM и AI",
